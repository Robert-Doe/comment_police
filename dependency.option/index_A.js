(() => {
    ...
    const OPT = {
        ...
        maxDepth: 1000,             // traversal depth cap
        maxSubtreeTextNodes: 1000, // cap for text-node scanning per element (for speed)
        maxSubtreeElements: 1000,  // cap for element scanning per element (for speed)
