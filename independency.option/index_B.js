(() => {
    if (!window.__commentFeatureScanPerNode?.results) {
        console.warn("Run the scan first so __commentFeatureScanPerNode.results exists.");
        return;
    }
     ...
     * Grouping
     ********************************************************************/
    const results = window.__commentFeatureScanPerNode.results;
    ...
    /********************************************************************
     * Attach to __commentFeatureScanPerNode
     ********************************************************************/
    window.__commentFeatureScanPerNode.xpath = {
        getXPath,
        getXPathStar,
        getParentXPath,
        byParentXPath,
    ...
    console.log(
        ...
        "Try:\n" +
        "  __commentFeatureScanPerNode.xpath.siblingsByIndex(0)\n" +
        "  __commentFeatureScanPerNode.xpath.sameTagSiblingsByIndex(0)\n" +
        "  __commentFeatureScanPerNode.xpath.topSiblingGroups({minSize:4, topN:10})\n" +
        "  __commentFeatureScanPerNode.xpath.highlightGroup(__commentFeatureScanPerNode.xpath.siblingsByIndex(0))"
    );
})();
